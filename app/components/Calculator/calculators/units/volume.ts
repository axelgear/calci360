 ...
 * Derived from Length³ (length × length × length)
 */

import type { UnitOption } from './types'
import { length } from './length'

/* Derive volume from length: length³ */
...
/** Common volume units for geometry calculators */
export const volumeUnitsCommon: UnitOption[] = [
  /* Metric */
  ...
  /* US Liquid */
  { id: 'gallon-us', name: 'US Gallon', symbol: 'gal', toBase: galUS },
  { id: 'quart-us', name: 'US Quart', symbol: 'qt', toBase: galUS / 4 },
  { id: 'pint-us', name: 'US Pint', symbol: 'pt', toBase: galUS / 8 },
  { id: 'cup-us', name: 'US Cup', symbol: 'cup', toBase: galUS / 16 },
  { id: 'fluid-ounce-us', name: 'US Fluid Ounce', symbol: 'fl oz', toBase: galUS / 128 },
  /* Imperial */
  { id: 'gallon-uk', name: 'Imperial Gallon', symbol: 'gal (imp)', toBase: galUK },
]

/** Full volume units for converter */
export const volumeUnitsFull: UnitOption[] = [
  ...
  /* Barrels */
  { id: 'barrel-oil', name: 'Barrel (Oil)', symbol: 'bbl', toBase: 42 * galUS },
  { id: 'barrel-us', name: 'Barrel (US Liquid)', symbol: 'bbl (US)', toBase: 31.5 * galUS },
